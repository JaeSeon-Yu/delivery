...
class BasketScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final productsPriceTotal =
        basket.fold<int>(0, (p, n) => p + n.product.price * n.count);
    final deliveryFeeTotal =
        basket.fold<int>(0, (p, n) => p + n.product.restaurant.deliveryFee);
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '₩${productsPriceTotal + deliveryFeeTotal}',
                        style: TextStyle(
                          fontWeight: FontWeight.w500,
                        ),
                      ),
                      ...
                      onPressed: () async {
                        ...
                        if (resp) {
                          ...
                          ScaffoldMessenger.of(context)
                              .showSnackBar(SnackBar(content: Text('결제실패')));
                        }
                      },
                      child: Text('결제하기'),
                    ),
